...
class AdminAuthorizationIntegrationTest {
    ...
    // Must match src/test/resources/application.yml's app.admin.password
    private static final String ADMIN_PASSWORD = "this-is-test-fixture-data-not-a-real-secret-do-not-reuse-it";
