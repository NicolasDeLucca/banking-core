...
@Service
public class AdminCloseAccountUseCase {

    private final AccountRepository accountRepository;
    private final ApplicationEventPublisher eventPublisher;

    public AdminCloseAccountUseCase(AccountRepository accountRepository, ApplicationEventPublisher eventPublisher) {
    ...
    public AccountResult execute(Long accountId, Long adminUserId) {
        ...
        eventPublisher.publishEvent(new AccountLifecycleEvent(saved.getId(), adminUserId, AccountLifecycleAction.CLOSED, Instant.now()));
