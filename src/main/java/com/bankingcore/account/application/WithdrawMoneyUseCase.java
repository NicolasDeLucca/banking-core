...
public class WithdrawMoneyUseCase {
    ...
    public WithdrawMoneyUseCase(AccountRepository accountRepository, ApplicationEventPublisher eventPublisher) {
    ...
    public AccountResult execute(Long accountId, Long requesterId, BigDecimal amount) {
        ...
        eventPublisher.publishEvent(AccountMovementEvent.of(saved.getId(), AccountMovementType.WITHDRAW, amount, Instant.now()));
