...
import com.bankingcore.account.application.CloseAccountUseCase;
import com.bankingcore.account.application.CreateAccountUseCase;
import com.bankingcore.account.application.DepositMoneyUseCase;
import com.bankingcore.account.application.GetAccountDetailsUseCase;
import com.bankingcore.account.application.ListUserAccountsUseCase;
import com.bankingcore.account.application.TransferMoneyUseCase;
import com.bankingcore.account.application.TransferResult;
import com.bankingcore.account.application.WithdrawMoneyUseCase;
import com.bankingcore.account.web.dtos.AccountResponse;
import com.bankingcore.account.web.dtos.AmountRequest;
import com.bankingcore.account.web.dtos.CreateAccountRequest;
import com.bankingcore.account.web.dtos.TransferRequest;
import com.bankingcore.account.web.dtos.TransferResponse;
